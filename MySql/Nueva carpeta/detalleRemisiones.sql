select
    ...
    purchaseorders.name as "Remisión",
    ...
    from purchaseordersproductsquantities
...
where
     purchaseordersgroups.trackingNumber like ('%13023%')	-- Folio
    -- purchaseorders.name		like ("%199172%")		-- Remisión
     and
    locations.externalId in (897)						-- Tienda
	-- and
	-- productsquantities.sapNumber = 11533886
