...
select * from transferslocations where transferId in (2383);
select * from transferslocations where id in (19);
...
select * from transfers where id in (327);

select * from transfers 
    LEFT JOIN locationsinfo on transferLocationTrackingNumber in (114)
    where trackingNumber in (29567);
    
select * from transfers where trackingNumber in (39258); 
select * from transfers where trackingNumber in (7778);   
select * from transfers where id in (39258);
select * from transfers where id in (31700);
  
select * from transferslocations where id in (7778);
select * from transferslocations where id in (19);
